...
For Developers
============
You can also see [Java](https://github.com/olcaytaner/Corpus), [Python](https://github.com/olcaytaner/Corpus-Py), or [C#](https://github.com/olcaytaner/Corpus-CS) repository.
